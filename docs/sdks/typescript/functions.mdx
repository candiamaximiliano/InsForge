...
description: Invoke InsForge serverless edge functions by slug from browser or Node.js apps with the InsForge TypeScript SDK, passing typed request and response payloads.
---
