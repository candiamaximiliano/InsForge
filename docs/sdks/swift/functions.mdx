...
description: Invoke InsForge serverless edge functions from iOS and macOS apps with the InsForge Swift SDK, passing typed request bodies and decoding JSON responses.
---
