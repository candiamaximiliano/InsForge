---
title: Next.js
description: "瞭解如何建立 InsForge 專案，並運用 AI 代理程式編碼快速建構 Next.js 全端應用程式，包含資料庫與身份驗證。"
---

瞭解如何建立 InsForge 專案並使用 AI 工具（如 Cursor）建構 Next.js 應用程式。
...
**InsForge 用戶端** 在 `lib/insforge.ts`:
