---
title: React
description: Aprende a crear un proyecto en InsForge y construir una aplicación React con IA, autenticación, base de datos Postgres y almacenamiento usando el SDK oficial.
---

import Installation from '/snippets/sdk-installation.mdx';

Aprenda cómo crear un proyecto InsForge y crear una aplicación React usando herramientas de IA como Cursor.
...
**Cliente InsForge** en `src/lib/insforge.ts`:
